...
function browserEdge() {
    ...
    //alert("I exisit!");
    if (isEdge) {
        document.getElementById("searchOptionsBody").style.backgroundImage = "none";
        document.getElementById("searchOptionsFooter").style.backgroundImage = "linear-gradient( to top, rgba(9, 9, 98, .9) 60px, rgba(9, 9, 98, .2), rgba(9, 9, 98, .0))";
    }
}
